...
import eu.grindclub.inventorylib.api.inventory.InventoryProperties
...
class InventoryHandlerImpl : InventoryHandler {
    ...
    override fun cacheInventory(holder: Player, title: Component, provider: InventoryProvider, staticInventory: Boolean): SpaceInventory? {
        ...
        val controller: eu.grindclub.inventorylib.api.inventory.InventoryController = InventoryControllerImpl(provider)
