package net.spacetivity.inventorylib.bukkit.api.inventory
...
class GuiHandlerImpl : GuiHandler {
    ...
    override fun cacheView(holder: Player, title: Component, provider: Gui, staticInventory: Boolean): GuiView? {
        ...
        val controller: net.spacetivity.inventorylib.api.inventory.GuiController = GuiControllerImpl(provider)
